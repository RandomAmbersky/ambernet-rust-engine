...
//         })
//     }
//     pub fn begin_frame(&mut self) -> Result<AsnWgpuFrameContext, AsnError> {
...
//         Ok(fcx)
//     }
//     pub fn end_frame(&mut self, fcx: AsnWgpuFrameContext) -> Result<(), AsnError> {
//         let state = self.state.as_mut().unwrap();
